...
- It does not handle img tags. 
- It may not create Pug files that have the correct indentation if the Pug files are not specified in the way the script expects. 
